...
export default function ServiceRecords() {
    ...
    let cols = [
        ...
        {
            key: "service_name",
            accessor: "service_records.0.service_name",
            title: "Service Name",
            sortable: true,
            style: {
                whiteSpace: "normal",
            ...
            filter: (
                <TextInput
                    ...
                    value={columnFilters["service_name"] || ""}
                    onChange={(e) =>
                        handleColumnSearchChange("service_name", e.target.value)
                    }
                />
            ),
            filtering: !!columnFilters["service_name"],
        },
        {
            key: "department",
            accessor: "service_records.0.department.name",
            title: "Department",
            sortable: true,
            style: {
                whiteSpace: "normal",
            ...
            filter: (
                <TextInput
                    ...
                    onChange={(e) =>
                        handleColumnSearchChange("department", e.target.value)
                    }
                />
            ),
            filtering: !!columnFilters["department"],
        },
    ];
    ...
    cols.push({
        ...
        render: (row) => (
            <div className="my-1 w-fit">
                <Link to={`/records/service/${row.id}`}>
